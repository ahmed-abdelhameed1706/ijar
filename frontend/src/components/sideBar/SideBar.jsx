  ...
  return (
    <>
      <aside
        ...
        className={
          openBar
            ? "absolute p-3 w-60 h-full bg-gray-50 transition-transform -translate-x-full  border-solid border-r border-gray-200 z-10"
      ...
      >
        <button
          className={
            openBar
              ? "min-[700px]:hidden bg-transparent inline-flex items-center text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
              : "min-[700px]:hidden"
          }
        ...
        <p className="text-sm py-2">
          Control and manage your account, and explore various options to
