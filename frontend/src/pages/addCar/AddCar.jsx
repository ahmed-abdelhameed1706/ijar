			...
			<div className=" flex max-w-full bg-white gap-6 p-5 min-[650px]:rounded-lg  min-[650px]:shadow-lg">
				...
				<Card className="w-full border-none shadow-none space-y-5">
					...
					<CardContent className="space-y-6">
                        <h1 className="text-lg font-medium border-b">Upload Photos <p className="text-xs font-light inline pl-2">multiple selection allowed</p></h1>                        
                        {images.length ? <Images images={images} /> : null}
                        <div className="flex flex-col items-center">
                            <label htmlFor="photos" className="bg-primary/[.33] text-base/[50px] flex justify-center items-center w-full cursor-pointer text-violet-800 h-12 rounded-xl">
                                <span><p className="text-xl inline pr-1.5">+</p>Add Photos</span>
                                <input
                                    type="file"
                                    id="photos"
                                    name="photos"
                        ...
                        <CardContent className="space-y-6">
                            <h1 className="text-lg font-medium border-b">Basic Characteristics</h1>
						<Form {...form}>
							<form
								...
								<FormField
										...
										render={({ field }) => (
											<FormItem className="w-full">
												...
												<p className="text-xs font-light inline pl-2">Optional field</p>
												<FormControl>
													<Textarea
