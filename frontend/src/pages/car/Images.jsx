    ...
    <div className="relative w-full">
      ...
      <button
        ...
        onClick={() => {
          setNext(cur);
          setCur(prev);
          prev > 0 ? setPrev(prev - 1) : setPrev(images.length - 1);
        }}
      ...
      <button
        ...
        onClick={() => {
          setPrev(cur);
          setCur(next);
          next < images.length - 1 ? setNext(next + 1) : setNext(0);
        }}
      ...
      <div className="flex justify-center items-center space-x-3 pt-4">
        {images.map((_, index) => (
          <button
            ...
            onClick={() => {
              setCur(index);
              index > 0 ? setPrev(index - 1) : setPrev(images.length - 1);
              index < images.length - 1 ? setNext(index + 1) : setNext(0);
            }}
          ></button>
        ))}
      </div>
